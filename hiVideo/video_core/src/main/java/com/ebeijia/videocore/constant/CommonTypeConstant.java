...
public enum AppType {
   ...
   public enum DomainType {
	...
	public enum RobotState {
		...
		//01在线，02播放，03暂停，04停止、00离线
		Leave("00", "离线"), Online("01", "在线"),pay("02", "播放"),oStop("03","暂停"),Stop("04","停止");
		...
		public static String getDescByValue(String value) {
			if (Leave.toString().equals(value)) {
				return Leave.desc;
			} else if(Online.toString().equals(value)){
				return Online.desc;
			}else if(pay.toString().equals(value)){
				return pay.desc;
			}else if(oStop.toString().equals(value)){
				return oStop.desc;
			}else{
				return Stop.desc;
			}
