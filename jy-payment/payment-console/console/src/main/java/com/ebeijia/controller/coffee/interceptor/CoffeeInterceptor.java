package com.ebeijia.controller.coffee.interceptor;
 ...
 * 用于验证访问连接时是否已经登入
 */
public class CoffeeInterceptor extends BaseValidRoleFunc implements HandlerInterceptor {
    private static Logger logger = LoggerFactory.getLogger(CoffeeInterceptor.class);
